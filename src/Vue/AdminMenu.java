...
public class AdminMenu {
    ...
    private void removeUser() {
        ...
        ArrayList<Personnel> students = this.getDatabase().getStudents();
        ...
        if (!found) {
            ArrayList<Personnel> teachers = this.getDatabase().getTeachers();
    ...
    private void changeUser() {
        ...
        ArrayList<Personnel> studients = this.getDatabase().getStudents();
    ...
    private void addUser() {
        ...
        case 3:
            this.getDatabase().addUser(
                    new Student(firstName, name, email, password, identifiant));
            break;
        }
    ...
    private void displayUsers() {
        ...
        ArrayList<Personnel> admins = this.getDatabase().getAdministrators();
